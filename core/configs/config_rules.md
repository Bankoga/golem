...
A cell map, as implemented by this framework, has 3 levels of asbtraction/organization that affect how cells, at the lowest level, operate. The levels, from highest to lowest, are as follows:
