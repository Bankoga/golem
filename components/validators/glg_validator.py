from validators.proc_validator import ProcValidator, ProcValidatorBuilder
from data.axioms.configs import proc_ids

class GLGValidator(ProcValidator):
  def __init__(self):
    super.__init__(proc_ids['glg'])
    pass

class GLGValidatorBuilder(ProcValidatorBuilder):
  def __init__(self):
    self._instance = None

  def __call__(self,**_ignored):
    super.__call__(proc_ids['glg'],**_ignored)
