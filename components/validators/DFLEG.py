...
type_data:
  id: DFLEG
  name: Decision Free Logos Encapsulator Group
  purpose: Represents an arbitrary cortical section that is free of L4 decision influence and outputs through a gate
  type: cortical
